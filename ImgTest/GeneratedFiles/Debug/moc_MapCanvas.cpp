...
const QMetaObject MapCanvas::staticMetaObject = {
    { &QGraphicsView::staticMetaObject, qt_meta_stringdata_MapCanvas.data,
      qt_meta_data_MapCanvas,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
